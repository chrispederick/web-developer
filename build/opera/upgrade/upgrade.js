...
{
  chrome.tabs.create({ "url": "http://chrispederick.com/work/web-developer/opera/installed/" + version.replace(".", "") + "/" });
};
...
WebDeveloper.Upgrade.upgrade = function()
{
  ...
  var version         = WebDeveloper.Upgrade.formatVersionNumber("0.1");
