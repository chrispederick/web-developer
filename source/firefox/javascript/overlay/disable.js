...
WebDeveloper.Overlay.Disable.toggleMetaRedirects = function(element)
{
	...
	WebDeveloper.Preferences.enableExtensionPreference(element, "meta.redirects.disable");
};
...
WebDeveloper.Overlay.Disable.updateDisableMenu = function()
{
	...
	if(WebDeveloper.Preferences.getIntegerPreference("network.http.sendRefererHeader") === 0)
	{
