...
{
	Components.classes["@mozilla.org/widget/clipboardhelper;1"].getService(Components.interfaces.nsIClipboardHelper).copyString(document.getElementById("web-developer-display-style-information-browser").contentDocument.defaultView.WebDeveloper.Dashboard.getAncestorPath());
...
{
	var generatedDocument = document.getElementById("web-developer-display-style-information-browser").contentDocument;
	...
	if(!styleInformation)
	{
		styleInformation += '<p id="web-developer-information">' + WebDeveloper.Locales.getString("noStyleInformation") + "</p>";
	}
...
// Initializes the display style information dashboard
WebDeveloper.StyleInformation.initialize = function()
{
	...
	for(var i = 0, l = documents.length; i < l; i++)
	{
		...
		WebDeveloper.Common.toggleStyleSheet("toolbar/style-sheets/element-ancestors.css", "web-developer-display-style-information-styles", contentDocument, false);
	}

	contentDocument																												= document.getElementById("web-developer-display-style-information-browser").contentDocument;
	contentDocument.getElementById("web-developer-information").innerHTML = WebDeveloper.Locales.getString("selectAnElementDisplayStyles");
...
// Uninitializes the display style information dashboard
WebDeveloper.StyleInformation.uninitialize = function()
{
	...
	document.getElementById("web-developer-display-style-information-browser").contentDocument.removeEventListener("click", WebDeveloper.StyleInformation.clickOutput, false);
};
