...
{
  WebDeveloper.Overlay.addFeatureOnTab(featureItem, tab, "/features/javascript/miscellaneous.js", scriptCode, args);
};
...
WebDeveloper.Overlay.Miscellaneous.displayColorPicker = function()
{
  ...
  WebDeveloper.Overlay.getSelectedTab(function(tab)
  {
    ...
    if(WebDeveloper.Overlay.isValidTab(tab))
    {
      ...
      {
        WebDeveloper.Overlay.toggleFeatureOnTab(featureItem, tab, "/toolbar/javascript/color-picker.js", function(featureEnabled, featureLocale) { WebDeveloper.ColorPicker.displayColorPicker(!featureEnabled, document, featureLocale); }, [enabled, locale]);
      });
    }
  });
};
...
WebDeveloper.Overlay.Miscellaneous.displayLineGuides = function()
{
  ...
  WebDeveloper.Overlay.getSelectedTab(function(tab)
  {
    ...
    if(WebDeveloper.Overlay.isValidTab(tab))
    {
      ...
      WebDeveloper.Storage.isFeatureOnTab(featureItem.getAttribute("id"), tab, function(enabled)
      {
        WebDeveloper.Overlay.toggleFeatureOnTab(featureItem, tab, "/toolbar/javascript/line-guides.js", function(featureEnabled, featureLocale) { WebDeveloper.LineGuides.displayLineGuides(!featureEnabled, document, featureLocale); }, [enabled, locale]);
      });
    }
  });
};
...
WebDeveloper.Overlay.Miscellaneous.displayRuler = function()
{
  ...
  WebDeveloper.Overlay.getSelectedTab(function(tab)
  {
    ...
    if(WebDeveloper.Overlay.isValidTab(tab))
    {
      ...
      WebDeveloper.Storage.isFeatureOnTab(featureItem.getAttribute("id"), tab, function(enabled)
      {
        WebDeveloper.Overlay.toggleFeatureOnTab(featureItem, tab, "/toolbar/javascript/ruler.js", function(featureEnabled, featureLocale) { WebDeveloper.Ruler.displayRuler(!featureEnabled, document, featureLocale); }, [enabled, locale]);
      });
    }
  });
};
...
{
  WebDeveloper.Overlay.toggleFeatureOnTab(featureItem, tab, "/features/javascript/miscellaneous.js", scriptCode, args);
};
