...
WebDeveloper.Forms.displayFormDetails = function(display, documents)
{
  ...
  for(var i = 0, l = documents.length; i < l; i++)
  {
    ...
    WebDeveloper.Common.toggleStyleSheet("/features/css/before.css", "web-developer-display-form-details-before", contentDocument, false);
    WebDeveloper.Common.toggleStyleSheet("/features/css/forms/display-form-details.css", "web-developer-display-form-details", contentDocument, false);
  }
};
...
WebDeveloper.Forms.outlineFormFieldsWithoutLabels = function(outline, documents)
{
  ...
  for(var i = 0, l = documents.length; i < l; i++)
  {
    ...
    WebDeveloper.Common.toggleStyleSheet("features/css/forms/outline-form-fields-without-labels.css", "web-developer-outline-form-fields-without-labels", contentDocument, false);
  }
};
...
WebDeveloper.Forms.populateFormFields = function(documents, emailAddress, password)
{
  ...
  // If the hours are a single digit
  if(hours < 10)
  {
    hours = "0" + hours;
  }
  ...
  time          = hours + ":" + minutes;
  localDateTime = dateString + "T" + time;
